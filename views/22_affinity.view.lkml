...
view: user_order_product {
  derived_table: {
    ...
    sql: SELECT
      ...
      FROM tridorian-wildan-sandbox-dev.ecomm.order_items oi
      LEFT JOIN tridorian-wildan-sandbox-dev.ecomm.inventory_items ii
        ON oi.inventory_item_id = ii.id
      LEFT JOIN tridorian-wildan-sandbox-dev.ecomm. products p
...
view: total_order_product {
  derived_table: {
    ...
    sql: SELECT
        ...
        , COUNT(*) AS prod_freq
      FROM tridorian-wildan-sandbox-dev.ecomm.order_items oi
      LEFT JOIN tridorian-wildan-sandbox-dev.ecomm.inventory_items
