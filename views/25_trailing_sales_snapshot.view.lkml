view: trailing_sales_snapshot {
  derived_table: {
    ...
    sql: with calendar as
      ...
      from tridorian-wildan-sandbox-dev.ecomm.inventory_items
      ...
      from tridorian-wildan-sandbox-dev.ecomm.order_items
      join tridorian-wildan-sandbox-dev.ecomm.inventory_items
